...
def compute_normalized_frequency(tensor_path: str) -> torch.Tensor:
    ...
    topk_features = normalized_freq.topk(k=50).indices.tolist()
    with open("frequencies_second_time/top50_features_layer7.txt", "w") as f:
    ...
    # with open("frequencies_second_time/retain_missing_features_layer7_machine_readable.txt", "r") as f:
    ...
    # with open("frequencies_second_time/features_to_clamp_layer7.txt", "w") as f:
    #     for feature in topk_features:
    #         f.write(f"{feature}\n")
    ...
    # with open("frequencies_second_time/retain_frequent_features_greater_than_0.0001_layer7_machine_readable.txt", "w") as f:
...
def main():
    tensor_forget_path = "/home/ubuntu/ML_Unlearning/sae_activations/forget_sae_activations_layer7.pt"
    tensor_retain_path = "/home/ubuntu/ML_Unlearning/sae_activations/retain_sae_activations_layer7.pt"
